...
def main():
    ...
    try:
        ...
        return module.fail_json(
            "cannot connect to rcon host " + module.params["address"]
        )
    except WrongPassword:
        return module.fail_json(
            "wrong password provided for rcon host " + module.params["address"]
        )
    except EmptyResponse:
        return module.fail_json(
            "no response from rcon host " + module.params["address"]
        )
